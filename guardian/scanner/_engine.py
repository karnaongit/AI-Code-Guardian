...
from guardian.core.models import Finding, ScanResult, Severity

DEFAULT_RULES_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "rules" / "Security_Rules.json"
