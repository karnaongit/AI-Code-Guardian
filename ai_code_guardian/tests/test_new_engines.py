...
class TestRequirementLoader:
    def test_load_json(self, tmp_path):
        from core.business_intent.loader import RequirementLoader
...
class TestRuleBasedExtractor:
    def test_extracts_authorization_rule(self):
        from core.business_intent.loader import RequirementLoader
        from core.business_intent.extractor import RuleBasedExtractor
        from core.business_intent.models import RuleType
...
class TestBusinessIntentMatcher:
    def test_matched_when_role_check_present(self):
        from core.business_intent.matcher import KeywordMatcher
        from core.business_intent.models import BusinessRule, MatchStatus, RuleType
...
class TestBusinessIntentScorer:
    def test_score_all_matched_returns_100(self):
        from core.business_intent.scorer import BusinessIntentScorer
        from core.business_intent.models import BusinessRule, MatchStatus, RuleMatch, RuleType
    ...
    def test_score_unimplemented_lowers_score(self):
        from core.business_intent.scorer import BusinessIntentScorer
        from core.business_intent.models import BusinessRule, MatchStatus, RuleMatch
...
class TestQuantumReadinessScorer:
    def test_perfect_score_when_no_usages(self):
        ...
        from core.quantum.models import CryptographicBOM
...
class TestCVENormalizer:
    def test_cwe_to_owasp_mapping(self):
        ...
        from core.threat_intelligence.models import CVERecord, FeedSource
...
class TestThreatContextAggregation:
    def test_from_cves_computes_max_cvss(self):
        from core.threat_intelligence.models import CVERecord, FeedSource, ThreatContext
        cves = [
